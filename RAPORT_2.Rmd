...
### 1. Wstęp teoretyczny i konstrukcja estymatora
...
### 2. Implementacja w środowisku R
...
Aby uzyskać bardzo dokładny wynik i znacząco zredukować wariancję (bardziej niż w metodach z punktu 4.1), zdecydowałem się połączyć dwie techniki:
...
Poniższy kod implementuje to podejście: dzieli przedział na $100\,000$ warstw i w każdej stosuje lokalną regresję jako metodę zmiennych kontrolnych.
...
# Parametry symulacji
k_strata <- 100000      # Liczba warstw
n_per_strata <- 1000    # Próbki na warstwę (dla stabilnej regresji)
